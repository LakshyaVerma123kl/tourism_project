...
import Signintemplate from "./sign_In";

const FSignin = () => {
  return (
    <div className="flex flex-wrap w-full h-full max-sm:space-y-0">
      <div className="w-[35%] max-sm:w-full max-sm:bg-cover max-sm:h-auto text-left h-full p-10 bg-[url('./assets/Dal.jpg')] bg-cover bg-no-repeat">
